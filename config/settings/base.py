...
ADMINS = [("""Sini Saarinen""", "sini.saarinen@csc.fi")]
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Documentation of API endpoiints of My Awesome Project",
    "VERSION": "1.0.0",
    "SERVE_PERMISSIONS": ["rest_framework.permissions.IsAdminUser"],
    "SERVERS": [
        {"url": "https://127.0.0.1:8000", "description": "Local Development server"},
        {"url": "https://csc.fi", "description": "Production server"},
    ],
}
# Your stuff...
# ------------------------------------------------------------------------------
